...
# Load the native extension - try multiple paths for vendored vs installed gems
begin
  require "redis_client/hiredis_connection.so"
rescue LoadError
  # For vendored gems, the extension may be in the ext directory directly
  require "hiredis_connection"
end
