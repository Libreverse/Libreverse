...
extern "C" {
  ...
  void Init_robotstxt() {
    ...
    // Define both instance and module function for convenient usage
    rb_define_method(m_Robotstxt, "allowed_by_robots", (ruby_method*)&robotstxt_allowed_by_robots, 3);
    rb_define_module_function(m_Robotstxt, "allowed_by_robots", (ruby_method*)&robotstxt_allowed_by_robots, 3);
  }
}
