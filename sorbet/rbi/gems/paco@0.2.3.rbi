...
module Paco::Combinators
  ...
  # source://paco//lib/paco/combinators.rb#129
...
class Paco::Parser
  ...
  # @return [Paco::Parser]
  #
  # source://paco//lib/paco/parser.rb#63
  def <(other); end
  ...
  # @return [Paco::Parser]
  #
  # source://paco//lib/paco/parser.rb#72
  def >(other); end
  ...
  # @return [Paco::Parser]
  #
  # source://paco//lib/paco/parser.rb#93
  def chain(&block); end
  ...
  # @return [Paco::Parser]
  #
  # source://paco//lib/paco/parser.rb#55
  def |(other); end
end
