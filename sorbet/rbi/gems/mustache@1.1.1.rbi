...
class Mustache
  ...
  # source://mustache//lib/mustache/settings.rb#51
  def path; end
...
class Mustache::Parser
  ...
  # source://mustache//lib/mustache/parser.rb#342
  def scan_tag_!(content, fetch, padding, pre_match_position); end

  # source://mustache//lib/mustache/parser.rb#348
  def scan_tag_=(content, fetch, padding, pre_match_position); end
...
class Mustache::Template
  ...
  # interpolation-friendly Ruby string.
  #
  # source://mustache//lib/mustache/template.rb#52
