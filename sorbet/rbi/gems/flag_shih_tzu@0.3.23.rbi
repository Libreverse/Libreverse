...
# source://flag_shih_tzu//lib/flag_shih_tzu/validators.rb#14
module ActiveModel; end

# Open ActiveModel::Validations to define some additional ones
#
# source://flag_shih_tzu//lib/flag_shih_tzu/validators.rb#16
...
#
# source://flag_shih_tzu//lib/flag_shih_tzu/validators.rb#36
module ActiveModel::Validations::HelperMethods
  ...
  #
  # source://flag_shih_tzu//lib/flag_shih_tzu/validators.rb#64
...
#
# source://flag_shih_tzu//lib/flag_shih_tzu/validators.rb#19
class ActiveModel::Validations::PresenceOfFlagsValidator < ::ActiveModel::EachValidator
  # source://flag_shih_tzu//lib/flag_shih_tzu/validators.rb#20
  def validate_each(record, attribute, value); end

  private

  # source://flag_shih_tzu//lib/flag_shih_tzu/validators.rb#28
  def check_flag(record, attribute); end
end

# source://flag_shih_tzu//lib/flag_shih_tzu.rb#4
module FlagShihTzu
  include GeneratedInstanceMethods
  ...
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#505
  ...
  #     end
  #
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#603
  ...
  #
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#546
  def update_flag!(flag, value, update_instance = T.unsafe(nil)); end

  private

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#612
  def collect_flags(*args); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#623
  def determine_flag_colmn_for(flag); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#619
  def get_bit_for(flag, colmn); end

  class << self
    # @private
    #
    # source://flag_shih_tzu//lib/flag_shih_tzu.rb#10
...
# source://flag_shih_tzu//lib/flag_shih_tzu.rb#23
module FlagShihTzu::ClassMethods
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#293
  def chained_flags_condition(colmn = T.unsafe(nil), *args); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#285
  def chained_flags_with(column = T.unsafe(nil), *args); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#257
  def check_flag(flag, colmn); end

  # @raise [NoSuchFlagException]
  #
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#275
  def determine_flag_colmn_for(flag); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#297
  def flag_keys(colmn = T.unsafe(nil)); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#24
  def has_flags(*args); end

  # Returns SQL statement to enable/disable flag.
  # Automatically determines the correct column.
  #
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#270
  ...
  # @return [Boolean]
  #
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#462
  def active_record_class?; end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#321
  def chained_flags_values(colmn, *args); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#356
  def check_flag_column(colmn, custom_table_name = T.unsafe(nil)); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#303
  def flag_full_column_name(table, column); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#307
  def flag_full_column_name_for_assignment(table, column); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#316
  ...
  #
  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#456
  def named_scope_method; end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#340
  def parse_flag_options(*args); end

  # source://flag_shih_tzu//lib/flag_shih_tzu.rb#410
