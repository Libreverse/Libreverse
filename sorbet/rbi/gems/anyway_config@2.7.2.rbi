...
class Anyway::Config
  ...
  # source://anyway_config//lib/anyway/config.rb#439
  def as_env; end
  ...
  # source://anyway_config//lib/anyway/config.rb#416
  def deconstruct_keys(keys); end

  # source://anyway_config//lib/anyway/config.rb#399
  def dig(*_arg0); end

  # source://anyway_config//lib/anyway/config.rb#403
  def dup; end
  ...
  # source://anyway_config//lib/anyway/config.rb#420
  def inspect; end

  # source://anyway_config//lib/anyway/config.rb#352
  def load(overrides = T.unsafe(nil)); end

  # source://anyway_config//lib/anyway/config.rb#392
  def load_from_sources(base_config, **opts); end

  # source://anyway_config//lib/anyway/config.rb#425
  ...
  # source://anyway_config//lib/anyway/config.rb#401
  def to_h; end

  # source://anyway_config//lib/anyway/config.rb#418
  ...
  #
  # source://anyway_config//lib/anyway/config.rb#445
  def __trace__; end

  # source://anyway_config//lib/anyway/config.rb#471
  def __type_caster__; end

  # @raise [ValidationError]
  #
  # source://anyway_config//lib/anyway/config.rb#467
  def raise_validation_error(msg); end

  # source://anyway_config//lib/anyway/config.rb#447
  ...
  # source://anyway_config//lib/anyway/config.rb#459
  ...
  class << self
    ...
    # source://anyway_config//lib/anyway/config.rb#216
    def coerce_types(mapping); end

    # source://anyway_config//lib/anyway/config.rb#227
    ...
    # source://anyway_config//lib/anyway/config.rb#260
    def disable_auto_cast!; end

    # source://anyway_config//lib/anyway/config.rb#190
    def env_prefix(val = T.unsafe(nil)); end

    # source://anyway_config//lib/anyway/config.rb#179
    def explicit_config_name; end

    # @return [Boolean]
    #
    # source://anyway_config//lib/anyway/config.rb#188
    def explicit_config_name?; end

    # source://anyway_config//lib/anyway/config.rb#248
    def fallback_type_caster(val = T.unsafe(nil)); end

    # source://anyway_config//lib/anyway/config.rb#161
    def load_callbacks; end

    # source://anyway_config//lib/anyway/config.rb#202
    def loader_options(val = T.unsafe(nil)); end

    # source://anyway_config//lib/anyway/config.rb#214
    ...
    # source://anyway_config//lib/anyway/config.rb#141
    def required_attributes; end

    # source://anyway_config//lib/anyway/config.rb#237
    def type_caster(val = T.unsafe(nil)); end

    private

    # source://anyway_config//lib/anyway/config.rb#281
    def accessors_module; end

    # source://anyway_config//lib/anyway/config.rb#289
    def build_config_name; end

    # source://anyway_config//lib/anyway/config.rb#266
...
# source://anyway_config//lib/anyway/config.rb#23
...
#
# source://anyway_config//lib/anyway/config.rb#27
...
module Anyway::Tracing
  ...
  # source://anyway_config//lib/anyway/tracing.rb#177
  def trace!(type, *path, **_arg2); end

  class << self
    # source://anyway_config//lib/anyway/tracing.rb#131
    def capture; end

    # source://anyway_config//lib/anyway/tracing.rb#149
    def current_trace; end

    # source://anyway_config//lib/anyway/tracing.rb#157
    def current_trace_source; end

    # source://anyway_config//lib/anyway/tracing.rb#153
    def source_stack; end

    # source://anyway_config//lib/anyway/tracing.rb#177
    def trace!(type, *path, **_arg2); end

    # source://anyway_config//lib/anyway/tracing.rb#145
    def trace_stack; end

    # source://anyway_config//lib/anyway/tracing.rb#151
    def tracing?; end

    # source://anyway_config//lib/anyway/tracing.rb#161
    def with_trace_source(src); end

    private

    # source://anyway_config//lib/anyway/tracing.rb#170
...
class Anyway::Tracing::Trace
  ...
  # source://anyway_config//lib/anyway/tracing.rb#81
  def clear; end

  # source://anyway_config//lib/anyway/tracing.rb#25
  def dig(*_arg0, **_arg1, &_arg2); end

  # source://anyway_config//lib/anyway/tracing.rb#93
  def dup; end

  # @raise [ArgumentError]
  #
  # source://anyway_config//lib/anyway/tracing.rb#76
  def keep_if(*_arg0, **_arg1, &_arg2); end

  # @raise [ArgumentError]
  #
  # source://anyway_config//lib/anyway/tracing.rb#63
  def merge!(another_trace); end

  # source://anyway_config//lib/anyway/tracing.rb#43
  def merge_values(hash, **opts); end

  # source://anyway_config//lib/anyway/tracing.rb#95
  def pretty_print(q); end
  ...
  # source://anyway_config//lib/anyway/tracing.rb#85
  def to_h; end

  # @return [Boolean]
  #
  # source://anyway_config//lib/anyway/tracing.rb#83
  def trace?; end
...
#
# source://anyway_config//lib/anyway/type_casting.rb#105
class Anyway::TypeCaster
  # @return [TypeCaster] a new instance of TypeCaster
  #
  # source://anyway_config//lib/anyway/type_casting.rb#109
  def initialize(mapping, registry: T.unsafe(nil), fallback: T.unsafe(nil)); end

  # source://anyway_config//lib/anyway/type_casting.rb#115
  ...
  #
  # source://anyway_config//lib/anyway/type_casting.rb#146
  def fallback; end
