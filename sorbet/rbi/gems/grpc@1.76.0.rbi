...
#
# source://grpc//src/ruby/lib/grpc/version.rb#16
module GRPC
  extend ::GRPC::DefaultLogger

  private

  # source://grpc//src/ruby/lib/grpc/grpc.rb#20
...
class GRPC::ActiveCall
  ...
  # source://grpc//src/ruby/lib/grpc/generic/active_call.rb#47
...
class GRPC::ActiveCall::InterceptableView
  ...
  # source://grpc//src/ruby/lib/grpc/generic/active_call.rb#640
...
module GRPC::Core::TimeConsts
  ...
  class << self
    ...
    # @return [Number|TimeSpec]
    #
    # source://grpc//src/ruby/lib/grpc/core/time_consts.rb#53
    def from_relative_time(timeish); end
  end
end
...
class GRPC::Notifier
  ...
  # Returns the value of attribute notified.
  #
  # source://grpc//src/ruby/lib/grpc/notifier.rb#20
  def notified?; end
...
class GRPC::RpcServer
  ...
  # source://grpc//src/ruby/lib/grpc/generic/rpc_server.rb#160
  ...
  #   the server to stop.
  #
  # source://grpc//src/ruby/lib/grpc/generic/rpc_server.rb#362
...
# source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#13
module Grpc; end

# Health contains classes and modules that support providing a health check
# service.
#
# source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#14
module Grpc::Health; end

# Checker is implementation of the schema-specified health checking service.
#
# source://grpc//src/ruby/pb/grpc/health/checker.rb#23
class Grpc::Health::Checker < ::Grpc::Health::V1::Health::Service
  # Initializes the statuses of participating services
  #
  # @return [Checker] a new instance of Checker
  #
  # source://grpc//src/ruby/pb/grpc/health/checker.rb#28
  def initialize; end

  # Adds the health status for a given service.
  #
  # source://grpc//src/ruby/pb/grpc/health/checker.rb#46
  def add_status(service, status); end

  # Adds health status for each service given within hash
  #
  # source://grpc//src/ruby/pb/grpc/health/checker.rb#58
  def add_statuses(service_statuses = T.unsafe(nil)); end

  # Implements the rpc IDL API method
  #
  # source://grpc//src/ruby/pb/grpc/health/checker.rb#34
  def check(req, _call); end

  # Clears alls the statuses.
  #
  # source://grpc//src/ruby/pb/grpc/health/checker.rb#70
  def clear_all; end

  # Clears the status for the given service.
  #
  # source://grpc//src/ruby/pb/grpc/health/checker.rb#65
  def clear_status(service); end

  # Adds given health status for all given services
  #
  # source://grpc//src/ruby/pb/grpc/health/checker.rb#51
  def set_status_for_services(status, *services); end
end

# source://grpc//src/ruby/pb/grpc/health/checker.rb#25
Grpc::Health::Checker::HealthCheckResponse = Grpc::Health::V1::HealthCheckResponse

# source://grpc//src/ruby/pb/grpc/health/checker.rb#24
Grpc::Health::Checker::StatusCodes = GRPC::Core::StatusCodes

# source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#15
module Grpc::Health::V1; end

# source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#28
module Grpc::Health::V1::Health; end

# source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#29
class Grpc::Health::V1::Health::Service
  include ::GRPC::GenericService
  extend ::GRPC::GenericService::Dsl

  # source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#39
  def check(*_arg0); end

  # source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#55
  def watch(*_arg0); end
end

# source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#58
class Grpc::Health::V1::Health::Stub < ::GRPC::ClientStub
  # source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#58
  def initialize(host, creds, **kw); end

  # source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#58
  def check(req, metadata = T.unsafe(nil)); end

  # source://grpc//src/ruby/pb/grpc/health/v1/health_services_pb.rb#58
  def watch(req, metadata = T.unsafe(nil), &blk); end
end
...
module Grpc::Health::V1::HealthCheckResponse::ServingStatus
  class << self
    # source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#18
    def descriptor; end
...
# source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#18
Grpc::Health::V1::HealthCheckResponse::ServingStatus::NOT_SERVING = T.let(T.unsafe(nil), Integer)

# source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#18
Grpc::Health::V1::HealthCheckResponse::ServingStatus::SERVICE_UNKNOWN = T.let(T.unsafe(nil), Integer)

# source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#18
Grpc::Health::V1::HealthCheckResponse::ServingStatus::SERVING = T.let(T.unsafe(nil), Integer)

# source://grpc//src/ruby/pb/grpc/health/v1/health_pb.rb#18
Grpc::Health::V1::HealthCheckResponse::ServingStatus::UNKNOWN = T.let(T.unsafe(nil), Integer)
