...
module RubyNext::Language
  class << self
    ...
    #
    # source://ruby-next-core//lib/ruby-next/language/parser.rb#53
    def builder_class; end

    # Sets the attribute builder_class
    #
    # @param value the value to set the attribute builder_class to.
    #
    # source://ruby-next-core//lib/ruby-next/language/parser.rb#53
    def builder_class=(_arg0); end
    ...
    # source://ruby-next-core//lib/ruby-next/language/parser.rb#63
    def parse(source, file = T.unsafe(nil)); end

    # source://ruby-next-core//lib/ruby-next/language/parser.rb#73
    def parse_with_comments(source, file = T.unsafe(nil)); end

    # source://ruby-next-core//lib/ruby-next/language/parser.rb#55
    def parser; end
...
class RubyNext::Language::PrismBuilder < ::Prism::Translation::Parser::Builder
  # source://ruby-next-core//lib/ruby-next/language/parser.rb#45
  def check_reserved_for_numparam(name, loc); end
end

# source://ruby-next-core//lib/ruby-next/language/parser.rb#92
class RubyNext::Language::PrismParser < ::Prism::Translation::Parser
  # source://ruby-next-core//lib/ruby-next/language/parser.rb#95
...
class RubyNext::Language::Rewriters::ArgsForwardLeading < ::RubyNext::Language::Rewriters::ArgsForward
  ...
  # Returns the value of attribute leading_farg.
  #
  # source://ruby-next-core//lib/ruby-next/language/rewriters/3.0/args_forward_leading.rb#12
  def leading_farg?; end
...
class RubyNext::Language::Rewriters::EndlessRange < ::RubyNext::Language::Rewriters::Base
  ...
  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.6/endless_range.rb#51
...
class RubyNext::Language::Rewriters::ItParam < ::RubyNext::Language::Rewriters::Base
  ...
  # source://ruby-next-core//lib/ruby-next/language/rewriters/3.4/it_param.rb#21
  ...
  # @return [Boolean]
  #
  # source://ruby-next-core//lib/ruby-next/language/rewriters/3.4/it_param.rb#51
  def block_has_it?(node); end

  # @return [Boolean]
  #
  # source://ruby-next-core//lib/ruby-next/language/rewriters/3.4/it_param.rb#64
  def it?(node); end

  # source://ruby-next-core//lib/ruby-next/language/rewriters/3.4/it_param.rb#31
  def process_block(node); end
end
...
class RubyNext::Language::Rewriters::OnelinePatternParensless < ::RubyNext::Language::Rewriters::Base
  ...
  # source://ruby-next-core//lib/ruby-next/language/rewriters/3.1/oneline_pattern_parensless.rb#37
...
class RubyNext::Language::Rewriters::PatternMatching < ::RubyNext::Language::Rewriters::Base
  ...
  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.7/pattern_matching.rb#310
  ...
  # =========== ARRAY PATTERN (START) ===============
  #
  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.7/pattern_matching.rb#507
  ...
  # =========== ARRAY PATTERN (START) ===============
  #
  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.7/pattern_matching.rb#508
...
class RubyNext::Language::Rewriters::Predicates::Base
  ...
  # Returns the value of attribute terminated.
  #
  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.7/pattern_matching.rb#113
  def terminated?; end
...
class RubyNext::Language::Rewriters::SquigglyHeredoc < ::RubyNext::Language::Rewriters::Base
  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.3/squiggly_heredoc.rb#31
  def on_dstr(node); end

  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.3/squiggly_heredoc.rb#11
  def on_str(node); end

  # source://ruby-next-core//lib/ruby-next/language/rewriters/2.3/squiggly_heredoc.rb#32
...
class RubyNext::Language::TransformContext
  ...
  # Returns the value of attribute use_ruby_next.
  #
  # source://ruby-next-core//lib/ruby-next/language.rb#53
  def use_ruby_next?; end
...
# source://ruby-next-core//lib/ruby-next/utils.rb#23
module RubyNext::Utils::A; end

# source://ruby-next-core//lib/ruby-next/utils.rb#24
