...
class SecureHeaders::Configuration
  ...
  class << self
    ...
    #
    # source://secure_headers//lib/secure_headers/configuration.rb#34
...
module SecureHeaders::DynamicConfig
  ...
  # source://secure_headers//lib/secure_headers/headers/content_security_policy_config.rb#53
  def [](directive); end

  # source://secure_headers//lib/secure_headers/headers/content_security_policy_config.rb#54
...
class SecureHeaders::NoOpHeaderConfig
  ...
  # source://secure_headers//lib/secure_headers.rb#41
  def [](*args); end

  # source://secure_headers//lib/secure_headers.rb#42
  def []=(*args); end
  ...
  # source://secure_headers//lib/secure_headers.rb#43
  def keys(*args); end
  ...
  class << self
    ...
    # source://secure_headers//lib/secure_headers.rb#23
    def allocate; end
...
module SecureHeaders::ViewHelpers
  ...
  # Returns a non-html-safe nonce value.
  #
  # source://secure_headers//lib/secure_headers/view_helper.rb#77
