...
module Hirb::View
  class << self
    ...
    # Returns the value of attribute config.
    #
    # source://hirb//lib/hirb/view.rb#67
    def config; end
...
module Hirb::Views::CouchDb
  # source://hirb//lib/hirb/views/couch_db.rb#7
  def couch_foo__base_view(obj); end

  # source://hirb//lib/hirb/views/couch_db.rb#8
  def couch_potato__persistence_view(obj); end

  # source://hirb//lib/hirb/views/couch_db.rb#6
...
module Hirb::Views::MongoDb
  ...
  # source://hirb//lib/hirb/views/mongo_db.rb#14
