...
module Lockbox
  ...
  class << self
    ...
    # source://lockbox//lib/lockbox.rb#82
    def encrypts_action_text_body(**options); end

    # source://lockbox//lib/lockbox.rb#47
    def generate_key; end

    # source://lockbox//lib/lockbox.rb#51
    def generate_key_pair; end

    # source://lockbox//lib/lockbox.rb#35
    def master_key; end
    ...
    # source://lockbox//lib/lockbox.rb#39
    def migrate(relation, batch_size: T.unsafe(nil), restart: T.unsafe(nil)); end

    # source://lockbox//lib/lockbox.rb#78
    def new(**options); end

    # source://lockbox//lib/lockbox.rb#43
    def rotate(relation, attributes:, batch_size: T.unsafe(nil)); end

    # source://lockbox//lib/lockbox.rb#74
    def to_hex(str); end
  end
end
...
# source://lockbox//lib/lockbox.rb#20
...
# source://lockbox//lib/lockbox/model.rb#712
module Lockbox::Model::Attached
  # source://lockbox//lib/lockbox/model.rb#713
