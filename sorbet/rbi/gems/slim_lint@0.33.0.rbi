...
class Object < ::BasicObject
  ...
  # source://slim_lint//lib/slim_lint/ruby_parser.rb#6
  def require_parser(path); end
end

# Defines the gem version.
#
# source://slim_lint//lib/slim_lint/constants.rb#4
module SlimLint; end
...
#
# source://slim_lint//lib/slim_lint/atom.rb#8
class SlimLint::Atom
...
#
# source://slim_lint//lib/slim_lint/capture_map.rb#6
...
#
# source://slim_lint//lib/slim_lint/configuration.rb#10
...
#
# source://slim_lint//lib/slim_lint/configuration_loader.rb#8
...
#
# source://slim_lint//lib/slim_lint/document.rb#5
...
#
# source://slim_lint//lib/slim_lint/engine.rb#16
...
#
# source://slim_lint//lib/slim_lint/exceptions.rb#4
module SlimLint::Exceptions; end

# Raised when a {Configuration} could not be loaded from a file.
#
# source://slim_lint//lib/slim_lint/exceptions.rb#6
...
#
# source://slim_lint//lib/slim_lint/file_finder.rb#8
...
# source://slim_lint//lib/slim_lint/filters/attribute_processor.rb#3
...
#
# source://slim_lint//lib/slim_lint/filters/attribute_processor.rb#6
...
#
# source://slim_lint//lib/slim_lint/filters/control_processor.rb#7
...
#
# source://slim_lint//lib/slim_lint/filters/inject_line_numbers.rb#9
...
# them more pleasant.
#
# source://slim_lint//lib/slim_lint/filters/sexp_converter.rb#8
...
# temporary variables or other cruft.
#
# source://slim_lint//lib/slim_lint/filters/splat_processor.rb#6
...
#
# source://slim_lint//lib/slim_lint/lint.rb#5
class SlimLint::Lint
  # Creates a new lint.
  #
...
# @abstract
#
# source://slim_lint//lib/slim_lint/linter.rb#7
class SlimLint::Linter
  ...
  # source://slim_lint//lib/slim_lint/linter.rb#89
  def linter_name; end
...
# source://slim_lint//lib/slim_lint/linter/comment_control_statement.rb#5
...
# source://slim_lint//lib/slim_lint/linter/consecutive_control_statements.rb#6
...
# source://slim_lint//lib/slim_lint/linter/control_statement_spacing.rb#5
class SlimLint::Linter::ControlStatementSpacing < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/control_statement_spacing.rb#11
  def on_pattern_1(sexp); end

  # source://slim_lint//lib/slim_lint/linter/control_statement_spacing.rb#25
  def on_pattern_2(sexp); end
end

# source://slim_lint//lib/slim_lint/linter/control_statement_spacing.rb#9
SlimLint::Linter::ControlStatementSpacing::MESSAGE_CONTROL = T.let(T.unsafe(nil), String)

# source://slim_lint//lib/slim_lint/linter/control_statement_spacing.rb#8
SlimLint::Linter::ControlStatementSpacing::MESSAGE_OUTPUT = T.let(T.unsafe(nil), String)

# source://slim_lint//lib/slim_lint/linter/embedded_engines.rb#5
...
# source://slim_lint//lib/slim_lint/linter/empty_control_statement.rb#5
...
# source://slim_lint//lib/slim_lint/linter/empty_lines.rb#6
...
# source://slim_lint//lib/slim_lint/linter/file_length.rb#5
...
# source://slim_lint//lib/slim_lint/linter/instance_variables.rb#5
class SlimLint::Linter::InstanceVariables < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/instance_variables.rb#8
  def on_start(_sexp); end

  private

  # source://slim_lint//lib/slim_lint/linter/instance_variables.rb#23
  def report_instance_variables(parsed_ruby, source_map); end
end

# source://slim_lint//lib/slim_lint/linter/line_length.rb#5
...
# source://slim_lint//lib/slim_lint/linter/quote_consistency.rb#5
class SlimLint::Linter::QuoteConsistency < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/quote_consistency.rb#10
  def on_pattern_1(node); end

  private

  # source://slim_lint//lib/slim_lint/linter/quote_consistency.rb#31
  def enforced_style; end
end

# source://slim_lint//lib/slim_lint/linter/quote_consistency.rb#8
SlimLint::Linter::QuoteConsistency::MSG = T.let(T.unsafe(nil), String)

# source://slim_lint//lib/slim_lint/linter/redundant_div.rb#6
...
# source://slim_lint//lib/slim_lint/linter/rubocop.rb#11
class SlimLint::Linter::RuboCop < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#17
  def initialize(config); end

  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#22
  def on_start(_sexp); end

  private

  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#63
  def extract_lints_from_offenses(offenses, source_map); end

  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#41
  def find_lints(ruby, source_map); end

  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#53
  def lint_file(file); end

  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#76
  def rubocop_flags; end

  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#88
  def with_ruby_from_stdin(ruby, &_block); end
end

# source://slim_lint//lib/slim_lint/linter/strict_locals_missing.rb#5
class SlimLint::Linter::StrictLocalsMissing < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/strict_locals_missing.rb#8
  def on_start(_sexp); end
end

# source://slim_lint//lib/slim_lint/linter/tab.rb#5
...
# source://slim_lint//lib/slim_lint/linter/tag.rb#5
class SlimLint::Linter::Tag < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/tag.rb#8
  def on_pattern_1(sexp); end
end

# source://slim_lint//lib/slim_lint/linter/tag_attribute.rb#5
class SlimLint::Linter::TagAttribute < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/tag_attribute.rb#8
  def on_pattern_1(sexp); end
end

# source://slim_lint//lib/slim_lint/linter/tag_case.rb#5
...
# source://slim_lint//lib/slim_lint/linter/trailing_blank_lines.rb#5
...
# source://slim_lint//lib/slim_lint/linter/trailing_whitespace.rb#5
...
# source://slim_lint//lib/slim_lint/linter/zwsp.rb#4
class SlimLint::Linter::Zwsp < ::SlimLint::Linter
  include ::SlimLint::LinterRegistry

  # source://slim_lint//lib/slim_lint/linter/zwsp.rb#9
  def on_start(_sexp); end
end

# source://slim_lint//lib/slim_lint/linter/zwsp.rb#7
SlimLint::Linter::Zwsp::MSG = T.let(T.unsafe(nil), String)

# Stores all defined linters.
#
# source://slim_lint//lib/slim_lint/linter_registry.rb#7
...
#
# source://slim_lint//lib/slim_lint/linter_selector.rb#5
...
#
# source://slim_lint//lib/slim_lint/logger.rb#5
...
# source://slim_lint//lib/slim_lint/matcher/base.rb#3
module SlimLint::Matcher; end

# Will match anything, acting as a wildcard.
#
# source://slim_lint//lib/slim_lint/matcher/anything.rb#5
...
# @abstract
#
# source://slim_lint//lib/slim_lint/matcher/base.rb#10
...
#
# source://slim_lint//lib/slim_lint/matcher/capture.rb#6
...
#
# source://slim_lint//lib/slim_lint/matcher/nothing.rb#7
...
# source://slim_lint//lib/slim_lint/linter_registry.rb#4
class SlimLint::NoSuchLinter < ::StandardError; end

# Collects offenses detected by RuboCop.
#
# source://slim_lint//lib/slim_lint/linter/rubocop.rb#101
class SlimLint::OffenseCollector < ::RuboCop::Formatter::BaseFormatter
  ...
  #
  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#119
  ...
  #
  # source://slim_lint//lib/slim_lint/linter/rubocop.rb#110
  def started(_target_files); end

  class << self
    # List of offenses reported by RuboCop.
    #
    # source://slim_lint//lib/slim_lint/linter/rubocop.rb#104
    def offenses; end
...
#
# source://slim_lint//lib/slim_lint/report.rb#5
...
# @abstract
#
# source://slim_lint//lib/slim_lint/reporter.rb#8
...
# source://slim_lint//lib/slim_lint/reporter/checkstyle_reporter.rb#7
...
# source://slim_lint//lib/slim_lint/reporter/default_reporter.rb#6
...
# source://slim_lint//lib/slim_lint/reporter/emacs_reporter.rb#5
...
# source://slim_lint//lib/slim_lint/reporter/github_reporter.rb#6
class SlimLint::Reporter::GithubReporter < ::SlimLint::Reporter
  # source://slim_lint//lib/slim_lint/reporter/github_reporter.rb#7
  def display_report(report); end

  private

  # source://slim_lint//lib/slim_lint/reporter/github_reporter.rb#27
  def print_location(lint); end

  # source://slim_lint//lib/slim_lint/reporter/github_reporter.rb#31
  def print_message(lint); end

  # source://slim_lint//lib/slim_lint/reporter/github_reporter.rb#19
  def print_type(lint); end
end

# source://slim_lint//lib/slim_lint/reporter/json_reporter.rb#5
...
# omitted.
#
# source://slim_lint//lib/slim_lint/ruby_extract_engine.rb#9
...
# will remain intact.
#
# source://slim_lint//lib/slim_lint/ruby_extractor.rb#31
...
#
# source://slim_lint//lib/slim_lint/ruby_extractor.rb#41
...
#
# source://slim_lint//lib/slim_lint/ruby_parser.rb#20
class SlimLint::RubyParser
  # Creates a reusable parser.
  #
  # @return [RubyParser] a new instance of RubyParser
  #
  # source://slim_lint//lib/slim_lint/ruby_parser.rb#22
  def initialize; end
  ...
  #
  # source://slim_lint//lib/slim_lint/ruby_parser.rb#32
  def parse(source); end
end

# Responsible for running the applicable linters against the desired files.
#
# source://slim_lint//lib/slim_lint/runner.rb#5
...
#
# source://slim_lint//lib/slim_lint/sexp.rb#8
...
#
# source://slim_lint//lib/slim_lint/sexp_visitor.rb#6
...
#
# source://slim_lint//lib/slim_lint/sexp_visitor.rb#80
...
#   callback
#
# source://slim_lint//lib/slim_lint/sexp_visitor.rb#73
...
#
# source://slim_lint//lib/slim_lint/utils.rb#5
