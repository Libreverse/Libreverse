...
class Sidekiq::JobRetry
  ...
  # source://sidekiq//lib/sidekiq/job_retry.rb#326
  def compress_backtrace(backtrace); end

  # returns (strategy, seconds)
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#219
  def delay_for(jobinst, count, exception, msg); end

  # @return [Boolean]
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#305
  def exception_caused_by_shutdown?(e, checked_causes = T.unsafe(nil)); end

  # Extract message from exception.
  # Set a default if the message raises an error
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#318
  ...
  # source://sidekiq//lib/sidekiq/job_retry.rb#250
  def retries_exhausted(jobinst, msg, exception); end

  # source://sidekiq//lib/sidekiq/job_retry.rb#297
  def retry_attempts_from(msg_retry, default); end

  # source://sidekiq//lib/sidekiq/job_retry.rb#275
  def run_death_handlers(job, exception); end

  # source://sidekiq//lib/sidekiq/job_retry.rb#283
  def send_to_morgue(msg); end

  # source://sidekiq//lib/sidekiq/job_retry.rb#210
