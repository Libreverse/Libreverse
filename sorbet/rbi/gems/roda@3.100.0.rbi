...
module Roda::RodaPlugins
  class << self
    ...
    # :nocov:
    #
    # source://roda//lib/roda/plugins.rb#56
    def set_temp_name(mod); end

    # source://roda//lib/roda/plugins.rb#19
...
#
# source://roda//lib/roda/request.rb#28
...
module Roda::RodaPlugins::Base::InstanceMethods
  ...
  # source://roda//lib/roda.rb#559
  def request; end

  # source://roda//lib/roda.rb#563
  def response; end
...
module Roda::RodaPlugins::Base::RequestClassMethods
  ...
  #
  # source://roda//lib/roda/request.rb#40
  ...
  #
  # source://roda//lib/roda/request.rb#53
  def inspect; end

  # The cache to use for match patterns for this request class.
  #
  # source://roda//lib/roda/request.rb#35
  ...
  #
  # source://roda//lib/roda/request.rb#32
  def roda_class; end
  ...
  # segments.
  #
  # source://roda//lib/roda/request.rb#62
...
module Roda::RodaPlugins::Base::RequestMethods
  ...
  #
  # source://roda//lib/roda/request.rb#85
  ...
  #
  # source://roda//lib/roda/request.rb#104
  ...
  #
  # source://roda//lib/roda/request.rb#127
  def inspect; end
  ...
  #   end
  #
  # source://roda//lib/roda/request.rb#193
  ...
  # @return [Boolean]
  #
  # source://roda//lib/roda/request.rb#207
  def is_get?; end

  # The already matched part of the path, including the original SCRIPT_NAME.
  #
  # source://roda//lib/roda/request.rb#247
  ...
  #   end
  #
  # source://roda//lib/roda/request.rb#238
  ...
  #   # => '/foo/bar'
  #
  # source://roda//lib/roda/request.rb#258
  def path; end
  ...
  # given fully consume the path.
  #
  # source://roda//lib/roda/request.rb#273
  ...
  #
  # source://roda//lib/roda/request.rb#268
  ...
  #   end
  #
  # source://roda//lib/roda/request.rb#300
  def redirect(path = T.unsafe(nil), status = T.unsafe(nil)); end

  # The current path to match requests against.
  #
  # source://roda//lib/roda/request.rb#264
  ...
  #
  # source://roda//lib/roda/request.rb#311
  def response; end

  # Return the Roda class related to this request.
  #
  # source://roda//lib/roda/request.rb#316
  def roda_class; end
  ...
  # path is empty.
  #
  # source://roda//lib/roda/request.rb#367
  def root(&block); end
  ...
  # a URL mapper.
  #
  # source://roda//lib/roda/request.rb#384
  def run(app); end
  ...
  #
  # source://roda//lib/roda/request.rb#412
  ...
  #
  # source://roda//lib/roda/request.rb#495
  ...
  #
  # source://roda//lib/roda/request.rb#459
  def _match_string(str); end

  # Match the given symbol if any segment matches.
  #
  # source://roda//lib/roda/request.rb#509
  def _match_symbol(sym = T.unsafe(nil)); end

  # The base remaining path to use.
  #
  # source://roda//lib/roda/request.rb#526
  ...
  # returned otherwise.
  #
  # source://roda//lib/roda/request.rb#550
  ...
  #
  # source://roda//lib/roda/request.rb#565
  ...
  # 302 by default.
  #
  # source://roda//lib/roda/request.rb#603
  ...
  # @return [Boolean]
  #
  # source://roda//lib/roda/request.rb#608
  def empty_path?; end
  ...
  #
  # source://roda//lib/roda/request.rb#615
  def if_match(args); end

  # Attempt to match the argument to the given request, handling
  # common ruby types.
  #
  # source://roda//lib/roda/request.rb#632
  ...
  #
  # source://roda//lib/roda/request.rb#668
  ...
  # @raise [RodaError]
  #
  # source://roda//lib/roda/request.rb#678
  ...
  # @raise [RodaError]
  #
  # source://roda//lib/roda/request.rb#683
  def unsupported_matcher(matcher); end
end

# source://roda//lib/roda/request.rb#70
...
module Roda::RodaPlugins::Base::ResponseMethods
  ...
  #
  # source://roda//lib/roda/response.rb#60
  def initialize; end
  ...
  #   response['Content-Type'] # => 'text/html'
  #
  # source://roda//lib/roda/response.rb#69
  def [](key); end
  ...
  #
  # source://roda//lib/roda/response.rb#50
  def body; end

  # The default headers to use for responses.
  #
  # source://roda//lib/roda/response.rb#81
  ...
  # @return [Boolean]
  #
  # source://roda//lib/roda/response.rb#92
  def empty?; end
  ...
  #   #      []]
  #
  # source://roda//lib/roda/response.rb#108
  def finish; end
  ...
  # body.
  #
  # source://roda//lib/roda/response.rb#134
  def finish_with_body(body); end

  # The hash of response headers for the current response.
  #
  # source://roda//lib/roda/response.rb#53
  def headers; end

  # Show response class, status code, response headers, and response body
  #
  # source://roda//lib/roda/response.rb#147
  def inspect; end
  ...
  #   response.write('foo')
  #
  # source://roda//lib/roda/response.rb#170
  def write(str); end
  ...
  #
  # source://roda//lib/roda/response.rb#204
  ...
  #
  # source://roda//lib/roda/response.rb#212
  def set_default_headers; end
end

# source://roda//lib/roda/response.rb#180
...
#   # "foo bar baz"
#
# source://roda//lib/roda/plugins/middleware.rb#103
module Roda::RodaPlugins::Middleware
  class << self
    ...
    #
    # source://roda//lib/roda/plugins/middleware.rb#122
    def configure(app, opts = T.unsafe(nil), &block); end
  end
end

# source://roda//lib/roda/plugins/middleware.rb#177
module Roda::RodaPlugins::Middleware::ClassMethods
  # Create a Forwarder instead of a new instance if a non-Hash is given.
  #
  # source://roda//lib/roda/plugins/middleware.rb#179
  def new(app, *args, &block); end
end

# Forwarder instances are what is actually used as middleware.
#
# source://roda//lib/roda/plugins/middleware.rb#132
class Roda::RodaPlugins::Middleware::Forwarder
  ...
  #
  # source://roda//lib/roda/plugins/middleware.rb#135
  def initialize(mid, app, *args, &block); end
  ...
  #
  # source://roda//lib/roda/plugins/middleware.rb#152
  def call(env); end
end

# source://roda//lib/roda/plugins/middleware.rb#188
module Roda::RodaPlugins::Middleware::InstanceMethods
  ...
  #
  # source://roda//lib/roda/plugins/middleware.rb#204
  def _roda_run_main_route(r); end

  # Override the route block so that if no route matches, we throw so
  # that the next middleware is called. Old Dispatch API.
  #
  # source://roda//lib/roda/plugins/middleware.rb#191
  def call(&block); end
end

# source://roda//lib/roda/plugins/middleware.rb#104
Roda::RodaPlugins::Middleware::NEXT_PROC = T.let(T.unsafe(nil), Proc)

# source://roda//lib/roda/plugins/middleware.rb#214
module Roda::RodaPlugins::Middleware::RequestMethods
  ...
  #
  # source://roda//lib/roda/plugins/middleware.rb#217
  def forward_next; end
end
...
#   end
#
# source://roda//lib/roda/plugins/pass.rb#21
module Roda::RodaPlugins::Pass; end

# source://roda//lib/roda/plugins/pass.rb#22
module Roda::RodaPlugins::Pass::RequestMethods
  # Skip the current match block as if it did not match.
  #
  # source://roda//lib/roda/plugins/pass.rb#24
  def pass; end
  ...
  #
  # source://roda//lib/roda/plugins/pass.rb#31
  def always; end

  # Handle passing inside the match block.
  #
  # source://roda//lib/roda/plugins/pass.rb#36
  def if_match(_); end
end
...
#
# source://roda//lib/roda/request.rb#22
