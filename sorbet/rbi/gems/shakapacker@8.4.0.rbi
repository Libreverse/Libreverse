...
class Shakapacker::Configuration
  ...
  # source://shakapacker//lib/shakapacker/configuration.rb#102
  def integrity; end
  ...
  # source://shakapacker//lib/shakapacker/configuration.rb#134
  def defaults; end

  # source://shakapacker//lib/shakapacker/configuration.rb#111
  def load; end

  # source://shakapacker//lib/shakapacker/configuration.rb#146
...
module Shakapacker::Helper
  # source://shakapacker//lib/shakapacker/helper.rb#187
  def append_javascript_pack_tag(*names, defer: T.unsafe(nil), async: T.unsafe(nil)); end

  # source://shakapacker//lib/shakapacker/helper.rb#174
  ...
  # source://shakapacker//lib/shakapacker/helper.rb#193
  ...
  # source://shakapacker//lib/shakapacker/helper.rb#233
  def available_sources_from_manifest_entrypoints(names, type:); end

  # source://shakapacker//lib/shakapacker/helper.rb#221
  def javascript_pack_tag_queue; end

  # source://shakapacker//lib/shakapacker/helper.rb#244
  def lookup_integrity(source); end

  # source://shakapacker//lib/shakapacker/helper.rb#248
  def lookup_source(source); end

  # Handles rendering javascript and stylesheet tags with integrity, if that's enabled.
  #
  # source://shakapacker//lib/shakapacker/helper.rb#253
  def render_tags(sources, type, options); end

  # source://shakapacker//lib/shakapacker/helper.rb#237
  def resolve_path_to_image(name, **options); end

  # source://shakapacker//lib/shakapacker/helper.rb#229
  def sources_from_manifest_entrypoints(names, type:); end

  # @yield [hash_key]
  #
  # source://shakapacker//lib/shakapacker/helper.rb#201
...
class Shakapacker::Manifest
  ...
  #
  # source://shakapacker//lib/shakapacker/manifest.rb#83
  def handle_missing_entry(name, pack_type); end

  # source://shakapacker//lib/shakapacker/manifest.rb#87
  def load; end
  ...
  #
  # source://shakapacker//lib/shakapacker/manifest.rb#98
  def manifest_name(name, pack_type); end

  # source://shakapacker//lib/shakapacker/manifest.rb#102
  def manifest_type(pack_type); end

  # source://shakapacker//lib/shakapacker/manifest.rb#110
