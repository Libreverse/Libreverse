...
class SitemapGenerator::Builder::SitemapIndexFile < ::SitemapGenerator::Builder::SitemapFile
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/builder/sitemap_index_file.rb#47
...
class SitemapGenerator::Interpreter
  ...
  # source://sitemap_generator//lib/sitemap_generator/interpreter.rb#11
...
class SitemapGenerator::Numeric
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#17
  def byte; end
  ...
  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#47
  def exabyte; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#44
  def exabytes; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#32
  def gigabyte; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#29
  def gigabytes; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#22
  def kilobyte; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#19
  def kilobytes; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#27
  def megabyte; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#24
  def megabytes; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#42
  def petabyte; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#39
  def petabytes; end

  # source://sitemap_generator//lib/sitemap_generator/core_ext/numeric.rb#37
  def terabyte; end
