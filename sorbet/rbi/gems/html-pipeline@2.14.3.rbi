...
# source://html-pipeline//lib/html/pipeline.rb#6
module HTML; end
...
#
# source://html-pipeline//lib/html/pipeline.rb#27
class HTML::Pipeline
  # @raise [ArgumentError]
  # @return [Pipeline] a new instance of Pipeline
  #
  # source://html-pipeline//lib/html/pipeline.rb#90
  ...
  #
  # source://html-pipeline//lib/html/pipeline.rb#110
  ...
  # Returns a Hash.
  #
  # source://html-pipeline//lib/html/pipeline.rb#183
  def default_payload(payload = T.unsafe(nil)); end

  # Public: Returns an Array of Filter objects for this Pipeline.
  #
  # source://html-pipeline//lib/html/pipeline.rb#72
  def filters; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline.rb#170
  def instrument(event, payload = T.unsafe(nil)); end

  # source://html-pipeline//lib/html/pipeline.rb#80
  def instrumentation_name; end

  # Public: String name for this Pipeline. Defaults to Class name.
  #
  # source://html-pipeline//lib/html/pipeline.rb#79
  ...
  #
  # source://html-pipeline//lib/html/pipeline.rb#76
  ...
  #
  # source://html-pipeline//lib/html/pipeline.rb#130
  ...
  # Returns nothing.
  #
  # source://html-pipeline//lib/html/pipeline.rb#160
  ...
  #
  # source://html-pipeline//lib/html/pipeline.rb#141
  def to_document(input, context = T.unsafe(nil), result = T.unsafe(nil)); end

  # Like call but guarantee the value returned is a string of HTML markup.
  #
  # source://html-pipeline//lib/html/pipeline.rb#147
  ...
  class << self
    ...
    #
    # source://html-pipeline//lib/html/pipeline.rb#87
    ...
    #
    # source://html-pipeline//lib/html/pipeline.rb#62
    def parse(document_or_html); end

    # source://html-pipeline//lib/html/pipeline.rb#50
    def require_dependency(name, requirer); end
  end
end

# source://html-pipeline//lib/html/pipeline/absolute_source_filter.rb#7
class HTML::Pipeline::AbsoluteSourceFilter < ::HTML::Pipeline::Filter
  ...
  #
  # source://html-pipeline//lib/html/pipeline/absolute_source_filter.rb#21
  def call; end

  # Private: the base url you want to use
  #
  # source://html-pipeline//lib/html/pipeline/absolute_source_filter.rb#42
  def image_base_url; end

  # Private: the relative url you want to use
  #
  # source://html-pipeline//lib/html/pipeline/absolute_source_filter.rb#47
...
# This filter does not write additional information to the context.
#
# source://html-pipeline//lib/html/pipeline/autolink_filter.rb#18
class HTML::Pipeline::AutolinkFilter < ::HTML::Pipeline::Filter
  # source://html-pipeline//lib/html/pipeline/autolink_filter.rb#19
  def call; end

  # source://html-pipeline//lib/html/pipeline/autolink_filter.rb#29
  def link_mode; end
end
...
#
# source://html-pipeline//lib/html/pipeline/body_content.rb#7
class HTML::Pipeline::BodyContent
  ...
  #
  # source://html-pipeline//lib/html/pipeline/body_content.rb#15
  ...
  #
  # source://html-pipeline//lib/html/pipeline/body_content.rb#39
  def document; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline/body_content.rb#32
  def output; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline/body_content.rb#8
  def result; end
end
...
# This filter does not write additional information to the context.
#
# source://html-pipeline//lib/html/pipeline/camo_filter.rb#23
class HTML::Pipeline::CamoFilter < ::HTML::Pipeline::Filter
  # @return [Boolean]
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#92
  def asset_host_allowed?(host); end

  # @return [Boolean]
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#87
  def asset_host_whitelisted?(host); end

  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#83
  ...
  # @return [Boolean]
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#65
  def asset_proxy_enabled?; end

  # Private: the host to use for generated asset proxied URLs.
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#70
  def asset_proxy_host; end

  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#74
  def asset_proxy_secret_key; end

  # The camouflaged URL for a given image URL.
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#55
  def asset_proxy_url(url); end

  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#78
  def asset_proxy_whitelist; end

  # Private: calculate the HMAC digest for a image source URL.
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#60
  ...
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#26
  def call; end

  # Private: helper to hexencode a string. Each byte ends up encoded into
  # two characters, zero padded value in the range [0-9a-f].
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#100
  def hexencode(str); end

  # Implementation of validate hook.
  # Errors should raise exceptions or use an existing validator.
  #
  # source://html-pipeline//lib/html/pipeline/camo_filter.rb#50
  def validate; end
end

# Our DOM implementation.
#
# source://html-pipeline//lib/html/pipeline.rb#58
...
#
# source://html-pipeline//lib/html/pipeline/emoji_filter.rb#15
class HTML::Pipeline::EmojiFilter < ::HTML::Pipeline::Filter
  ...
  #
  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#59
  ...
  #
  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#51
  def asset_root; end

  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#18
  def call; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#41
  def emoji_image_filter(text); end

  # Implementation of validate hook.
  # Errors should raise exceptions or use an existing validator.
  #
  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#32
  def validate; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#82
  def default_img_attrs(name); end

  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#111
  def emoji_filename(name); end

  # Build an emoji image tag
  #
  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#70
  def emoji_image_tag(name); end

  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#103
  def emoji_pattern; end

  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#94
  def emoji_url(name); end

  # Return ancestor tags to stop the emojification.
  #
  # @return [Array<String>] Ancestor tags.
  #
  # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#118
  def ignored_ancestor_tags; end

  class << self
    # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#107
    def emoji_names; end

    # Build a regexp that matches all valid :emoji: names.
    #
    # source://html-pipeline//lib/html/pipeline/emoji_filter.rb#99
    def emoji_pattern; end
  end
end

# source://html-pipeline//lib/html/pipeline/emoji_filter.rb#16
HTML::Pipeline::EmojiFilter::DEFAULT_IGNORED_ANCESTOR_TAGS = T.let(T.unsafe(nil), Array)
...
# docs for more info.
#
# source://html-pipeline//lib/html/pipeline/filter.rb#31
class HTML::Pipeline::Filter
  # @return [Filter] a new instance of Filter
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#34
  ...
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#100
  def base_url; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#76
  def call; end
  ...
  # caller.
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#50
  def context; end

  # The User object provided in the context hash, or nil when no user
  # was specified
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#94
  ...
  # method is called.
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#60
  def doc; end
  ...
  # @return [Boolean]
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#118
  ...
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#67
  def html; end
  ...
  # require them.
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#155
  def needs(*keys); end
  ...
  # returned unmodified.
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#107
  ...
  # for permissions
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#88
  def repository; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#55
  def result; end

  # Make sure the context has everything we need. Noop: Subclasses can override.
  #
  # source://html-pipeline//lib/html/pipeline/filter.rb#81
  def validate; end
  ...
  class << self
    ...
    # markup.
    #
    # source://html-pipeline//lib/html/pipeline/filter.rb#128
    ...
    #
    # source://html-pipeline//lib/html/pipeline/filter.rb#134
    def to_document(input, context = T.unsafe(nil)); end

    # Like call but guarantees that a string of HTML markup is returned.
    #
    # source://html-pipeline//lib/html/pipeline/filter.rb#140
    def to_html(input, context = T.unsafe(nil)); end
  end
end

# source://html-pipeline//lib/html/pipeline/filter.rb#32
...
#
# source://html-pipeline//lib/html/pipeline/https_filter.rb#10
class HTML::Pipeline::HttpsFilter < ::HTML::Pipeline::Filter
  # source://html-pipeline//lib/html/pipeline/https_filter.rb#11
  def call; end

  # HTTP url to replace. Falls back to :base_url
  #
  # source://html-pipeline//lib/html/pipeline/https_filter.rb#19
  def http_url; end

  # Raise error if :http_url undefined
  #
  # source://html-pipeline//lib/html/pipeline/https_filter.rb#24
  def validate; end
end
...
#
# source://html-pipeline//lib/html/pipeline/image_filter.rb#11
class HTML::Pipeline::ImageFilter < ::HTML::Pipeline::TextFilter
  # source://html-pipeline//lib/html/pipeline/image_filter.rb#12
  def call; end
end
...
#
# source://html-pipeline//lib/html/pipeline/image_max_width_filter.rb#11
class HTML::Pipeline::ImageMaxWidthFilter < ::HTML::Pipeline::Filter
  # source://html-pipeline//lib/html/pipeline/image_max_width_filter.rb#12
  def call; end

  # source://html-pipeline//lib/html/pipeline/image_max_width_filter.rb#30
...
#                       identify usernames
#
# source://html-pipeline//lib/html/pipeline/@mention_filter.rb#19
class HTML::Pipeline::MentionFilter < ::HTML::Pipeline::Filter
  # source://html-pipeline//lib/html/pipeline/@mention_filter.rb#72
  def call; end
  ...
  #
  # source://html-pipeline//lib/html/pipeline/@mention_filter.rb#88
  def info_url; end

  # source://html-pipeline//lib/html/pipeline/@mention_filter.rb#121
  def link_to_mention_info(text, info_url = T.unsafe(nil)); end

  # source://html-pipeline//lib/html/pipeline/@mention_filter.rb#128
  ...
  #
  # source://html-pipeline//lib/html/pipeline/@mention_filter.rb#108
  def mention_link_filter(text, _base_url = T.unsafe(nil), info_url = T.unsafe(nil), username_pattern = T.unsafe(nil)); end

  # source://html-pipeline//lib/html/pipeline/@mention_filter.rb#92
  ...
  class << self
    ...
    #
    # source://html-pipeline//lib/html/pipeline/@mention_filter.rb#34
...
#
# source://html-pipeline//lib/html/pipeline/@mention_filter.rb#70
...
#
# source://html-pipeline//lib/html/pipeline/@mention_filter.rb#62
...
#
# source://html-pipeline//lib/html/pipeline/@mention_filter.rb#42
...
#
# source://html-pipeline//lib/html/pipeline/@mention_filter.rb#58
HTML::Pipeline::MentionFilter::UsernamePattern = T.let(T.unsafe(nil), Regexp)

# source://html-pipeline//lib/html/pipeline.rb#49
...
# This filter does not write additional information to the context.
#
# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#25
class HTML::Pipeline::SanitizationFilter < ::HTML::Pipeline::Filter
  ...
  #
  # source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#133
  def allowlist; end

  # Sanitize markup using the Sanitize library.
  #
  # source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#122
  def call; end

  # source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#126
  def whitelist; end
end
...
#
# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#42
HTML::Pipeline::SanitizationFilter::ALLOWLIST = T.let(T.unsafe(nil), Hash)

# These schemes are the only ones allowed in <a href> attributes by default.
#
# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#38
HTML::Pipeline::SanitizationFilter::ANCHOR_SCHEMES = T.let(T.unsafe(nil), Array)

# Strip all HTML tags from the document.
#
# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#119
HTML::Pipeline::SanitizationFilter::FULL = T.let(T.unsafe(nil), Hash)
...
#
# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#114
HTML::Pipeline::SanitizationFilter::LIMITED = T.let(T.unsafe(nil), Hash)

# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#26
HTML::Pipeline::SanitizationFilter::LISTS = T.let(T.unsafe(nil), Set)

# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#27
HTML::Pipeline::SanitizationFilter::LIST_ITEM = T.let(T.unsafe(nil), String)

# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#34
HTML::Pipeline::SanitizationFilter::TABLE = T.let(T.unsafe(nil), String)
...
#
# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#33
HTML::Pipeline::SanitizationFilter::TABLE_ITEMS = T.let(T.unsafe(nil), Set)

# source://html-pipeline//lib/html/pipeline/sanitization_filter.rb#35
HTML::Pipeline::SanitizationFilter::TABLE_SECTIONS = T.let(T.unsafe(nil), Set)
...
#
# source://html-pipeline//lib/html/pipeline/syntax_highlight_filter.rb#16
class HTML::Pipeline::SyntaxHighlightFilter < ::HTML::Pipeline::Filter
  ...
  #
  # source://html-pipeline//lib/html/pipeline/syntax_highlight_filter.rb#17
  def initialize(*args); end

  # source://html-pipeline//lib/html/pipeline/syntax_highlight_filter.rb#22
  def call; end

  # source://html-pipeline//lib/html/pipeline/syntax_highlight_filter.rb#39
  def highlight_with_timeout_handling(text, lexer); end

  # source://html-pipeline//lib/html/pipeline/syntax_highlight_filter.rb#45
...
#                       identify team names
#
# source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#16
class HTML::Pipeline::TeamMentionFilter < ::HTML::Pipeline::Filter
  # source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#52
  def call; end

  # source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#87
  ...
  #
  # source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#79
  def mention_link_filter(text, _base_url = T.unsafe(nil), team_pattern = T.unsafe(nil)); end

  # source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#66
  ...
  class << self
    ...
    # Returns a String replaced with the return of the block.
    #
    # source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#30
...
# Don't look for mentions in text nodes that are children of these elements
#
# source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#50
...
#
# source://html-pipeline//lib/html/pipeline/@team_mention_filter.rb#41
HTML::Pipeline::TeamMentionFilter::TeamPattern = T.let(T.unsafe(nil), Regexp)

# source://html-pipeline//lib/html/pipeline/text_filter.rb#5
class HTML::Pipeline::TextFilter < ::HTML::Pipeline::Filter
  # @raise [TypeError]
  # @return [TextFilter] a new instance of TextFilter
  #
  # source://html-pipeline//lib/html/pipeline/text_filter.rb#8
  def initialize(text, context = T.unsafe(nil), result = T.unsafe(nil)); end

  # Returns the value of attribute text.
  #
  # source://html-pipeline//lib/html/pipeline/text_filter.rb#6
  def text; end
end

# source://html-pipeline//lib/html/pipeline/version.rb#5
