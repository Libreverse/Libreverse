...
class ActiveRecordDoctor::Detectors::Base
  ...
  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#293
  def each_association(model, except: T.unsafe(nil), type: T.unsafe(nil), has_scope: T.unsafe(nil), through: T.unsafe(nil)); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#215
  def each_attribute(model, except: T.unsafe(nil), type: T.unsafe(nil)); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#232
  def each_column(table_name, only: T.unsafe(nil), except: T.unsafe(nil)); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#279
  def each_data_source(except: T.unsafe(nil)); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#254
  def each_foreign_key(table_name); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#189
  def each_index(table_name, except: T.unsafe(nil), multicolumn_only: T.unsafe(nil)); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#166
  def each_model(except: T.unsafe(nil), abstract: T.unsafe(nil), existing_tables_only: T.unsafe(nil)); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#264
  def each_table(except: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#324
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#247
  def looks_like_foreign_key?(column); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#91
  def message(**_attrs); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#158
  def models; end
  ...
  # source://active_record_doctor//lib/active_record_doctor/detectors/base.rb#162
...
class ActiveRecordDoctor::Detectors::ExtraneousIndexes < ::ActiveRecordDoctor::Detectors::Base
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/extraneous_indexes.rb#101
  def contains_all?(array1, array2); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/extraneous_indexes.rb#32
  def detect; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/extraneous_indexes.rb#105
  def includes(index); end
  ...
  # source://active_record_doctor//lib/active_record_doctor/detectors/extraneous_indexes.rb#93
  def opclasses(index); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/extraneous_indexes.rb#97
...
class ActiveRecordDoctor::Detectors::IncorrectDependentOption < ::ActiveRecordDoctor::Detectors::Base
  ...
  # source://active_record_doctor//lib/active_record_doctor/detectors/incorrect_dependent_option.rb#176
  ...
  # source://active_record_doctor//lib/active_record_doctor/detectors/incorrect_dependent_option.rb#182
...
class ActiveRecordDoctor::Detectors::IncorrectLengthValidation < ::ActiveRecordDoctor::Detectors::Base
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/incorrect_length_validation.rb#61
  def covered_by_inclusion_validation?(model, column, limit); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/incorrect_length_validation.rb#33
  def detect; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/incorrect_length_validation.rb#52
  def maximum_allowed_by_length_validation(model, column); end
...
class ActiveRecordDoctor::Detectors::MissingNonNullConstraint < ::ActiveRecordDoctor::Detectors::Base
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#100
  def conditional_validator?(validator); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#35
  def detect; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#23
  def message(column:, table:); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#64
  def non_null_needed?(model, column); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#104
  def proc_from_activerecord?(object); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#93
  def rails_belongs_to_presence_validator?(validator); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#80
  def required_presence_validators(model); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#59
  def sti_base_model?(model); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#89
  def sti_column?(models, column_name); end
end

# source://active_record_doctor//lib/active_record_doctor/detectors/missing_non_null_constraint.rb#21
ActiveRecordDoctor::Detectors::MissingNonNullConstraint::TIMESTAMPS = T.let(T.unsafe(nil), Array)
...
class ActiveRecordDoctor::Detectors::MissingPresenceValidation < ::ActiveRecordDoctor::Detectors::Base
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_presence_validation.rb#177
  def counter_cache_column?(model, column); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_presence_validation.rb#35
  def detect; end

  # Normalizes the list of values passed to an inclusion or exclusion validator.
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_presence_validation.rb#171
  def inclusion_or_exclusion_validator_items(validator); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_presence_validation.rb#24
  def message(type:, column:, reflection:, model:); end
end
...
class ActiveRecordDoctor::Detectors::MissingUniqueIndexes < ::ActiveRecordDoctor::Detectors::Base
  # @return [MissingUniqueIndexes] a new instance of MissingUniqueIndexes
  #
  ...
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#45
  def detect; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#180
  def extract_index_columns(columns); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#124
  def has_and_belongs_to_many_without_indexes; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#98
  def has_ones_without_indexes; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#170
  def ignore_columns; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#30
  def message(model:, table:, columns:, problem:); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#139
  def resolve_attributes(model, attributes); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#153
  def unique_index?(table_name, columns, scope = T.unsafe(nil)); end

  # source://active_record_doctor//lib/active_record_doctor/detectors/missing_unique_indexes.rb#51
...
class ActiveRecordDoctor::Detectors::ShortPrimaryKeyType < ::ActiveRecordDoctor::Detectors::Base
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/short_primary_key_type.rb#34
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/short_primary_key_type.rb#42
...
# source://active_record_doctor//lib/active_record_doctor/detectors/table_without_primary_key.rb#7
class ActiveRecordDoctor::Detectors::TableWithoutPrimaryKey < ::ActiveRecordDoctor::Detectors::Base
  private

  # source://active_record_doctor//lib/active_record_doctor/detectors/table_without_primary_key.rb#22
  def detect; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/table_without_primary_key.rb#18
  def message(table:); end
end

# source://active_record_doctor//lib/active_record_doctor/detectors/table_without_timestamps.rb#7
class ActiveRecordDoctor::Detectors::TableWithoutTimestamps < ::ActiveRecordDoctor::Detectors::Base
  private

  # source://active_record_doctor//lib/active_record_doctor/detectors/table_without_timestamps.rb#27
  def detect; end

  # source://active_record_doctor//lib/active_record_doctor/detectors/table_without_timestamps.rb#23
  def message(table:, column:); end
end

# source://active_record_doctor//lib/active_record_doctor/detectors/table_without_timestamps.rb#18
ActiveRecordDoctor::Detectors::TableWithoutTimestamps::TIMESTAMPS = T.let(T.unsafe(nil), Hash)
...
class ActiveRecordDoctor::Detectors::UnindexedForeignKeys < ::ActiveRecordDoctor::Detectors::Base
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/unindexed_foreign_keys.rb#67
  ...
  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/unindexed_foreign_keys.rb#55
  def indexed?(table, column); end

  # @return [Boolean]
  #
  # source://active_record_doctor//lib/active_record_doctor/detectors/unindexed_foreign_keys.rb#61
...
module ActiveRecordDoctor::Utils
  class << self
    ...
    def sqlite?(connection = T.unsafe(nil)); end
  end
end
