...
module Hashie::Extensions::Coercion
  ...
  class << self
    # @private
    #
    # source://hashie//lib/hashie/extensions/coercion.rb#22
    def included(base); end
  end
end
...
module Hashie::Extensions::Coercion::ClassMethods
  # source://hashie//lib/hashie/extensions/coercion.rb#160
  def build_coercion(type); end

  # source://hashie//lib/hashie/extensions/coercion.rb#195
  ...
  # source://hashie//lib/hashie/extensions/coercion.rb#187
  ...
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#75
  ...
  # @param key [Object] the key or array of keys you would like to be coerced.
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#80
  ...
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#114
  def coerce_value(from, into, options = T.unsafe(nil)); end

  # source://hashie//lib/hashie/extensions/coercion.rb#154
  def coercion_cache; end

  # source://hashie//lib/hashie/extensions/coercion.rb#149
  def fetch_coercion(type); end

  # source://hashie//lib/hashie/extensions/coercion.rb#210
  def inherited(klass); end

  # Returns the specific key coercion for the specified key,
  # if one exists.
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#89
  def key_coercion(key); end

  # Returns a hash of any existing key coercions.
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#83
  def key_coercions; end

  # Return all value coercions that have the :strict rule as false.
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#139
  def lenient_value_coercions; end

  # Return all value coercions that have the :strict rule as true.
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#134
  def strict_value_coercions; end

  # Fetch the value coercion, if any, for the specified object.
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#144
  ...
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#58
  def key_coercions=(_arg0); end
end

# source://hashie//lib/hashie/extensions/coercion.rb#31
module Hashie::Extensions::Coercion::InstanceMethods
  # source://hashie//lib/hashie/extensions/coercion.rb#46
  def custom_writer(key, value, _convert = T.unsafe(nil)); end

  # source://hashie//lib/hashie/extensions/coercion.rb#50
  def replace(other_hash); end

  # source://hashie//lib/hashie/extensions/coercion.rb#32
