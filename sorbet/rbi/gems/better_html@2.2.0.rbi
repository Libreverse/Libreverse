...
# source://better_html//lib/better_html.rb#8
module BetterHtml
  class << self
    # source://better_html//lib/better_html.rb#12
    def config; end
    ...
    #
    # source://better_html//lib/better_html.rb#10
    def config=(_arg0); end

    # @yield [config]
    #
    # source://better_html//lib/better_html.rb#16
    def configure; end
  end
end
