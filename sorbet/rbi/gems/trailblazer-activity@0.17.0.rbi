...
#
# source://trailblazer-activity//lib/trailblazer/activity/version.rb#1
...
#
# source://trailblazer-activity//lib/trailblazer/activity.rb#5
class Trailblazer::Activity
  extend ::Trailblazer::Activity::Call
  ...
  # source://trailblazer-activity//lib/trailblazer/activity.rb#21
  def inspect; end

  # source://trailblazer-activity//lib/trailblazer/activity.rb#17
  def to_h; end

  class << self
    # Builds an {Activity::End} instance.
    #
    # source://trailblazer-activity//lib/trailblazer/activity/structures.rb#54
    def End(semantic); end

    # Builds an {Activity::Output} instance.
    #
    # source://trailblazer-activity//lib/trailblazer/activity/structures.rb#49
...
#
# source://trailblazer-activity//lib/trailblazer/activity/adds.rb#10
module Trailblazer::Activity::Adds
  private

  # Inserts one or more {Adds} into {pipeline}.
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#22
  def apply_adds(pipeline, adds); end

  # @private
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#15
...
# end
#
# source://trailblazer-activity//lib/trailblazer/activity/adds.rb#37
module Trailblazer::Activity::Adds::FriendlyInterface
  class << self
    ...
    #
    # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#43
    def adds_for(inserts); end

    # @private
    #
    # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#50
...
# Insert
#
# source://trailblazer-activity//lib/trailblazer/activity/adds.rb#144
class Trailblazer::Activity::Adds::IndexError < ::IndexError
  # @return [IndexError] a new instance of IndexError
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#145
...
#
# source://trailblazer-activity//lib/trailblazer/activity/adds.rb#66
module Trailblazer::Activity::Adds::Insert
  private

  # Append {new_row} after {insert_id}.
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#70
  def Append(pipeline, new_row, insert_id = T.unsafe(nil)); end

  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#93
  def Delete(pipeline, _, insert_id); end

  # Insert {new_row} before {insert_id}.
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#79
  def Prepend(pipeline, new_row, insert_id = T.unsafe(nil)); end

  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#87
  ...
  # @private
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#115
  def apply_on_ary(pipeline, insert_id, raise_index_error: T.unsafe(nil), &block); end

  # @private
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#100
  def build(sequence, rows); end

  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#128
  def build_from_ary(pipeline, insert_id, &block); end

  # @private
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#105
  ...
  # @private
  #
  # source://trailblazer-activity//lib/trailblazer/activity/adds.rb#138
...
# source://trailblazer-activity//lib/trailblazer/activity.rb#25
module Trailblazer::Activity::Call
  # Canonical entry-point to invoke an {Activity} or Strategy such as {Activity::Railway}
  # with its taskWrap.
  #
  # source://trailblazer-activity//lib/trailblazer/activity.rb#28
...
# @see Activity
#
# source://trailblazer-activity//lib/trailblazer/activity/circuit.rb#17
class Trailblazer::Activity::Circuit
  ...
  # @api semi-private
  #
  # source://trailblazer-activity//lib/trailblazer/activity/circuit.rb#78
...
# @api semi-private
#
# source://trailblazer-activity//lib/trailblazer/activity/circuit.rb#87
class Trailblazer::Activity::Circuit::IllegalSignalError < ::RuntimeError
  ...
  #
  # source://trailblazer-activity//lib/trailblazer/activity/circuit.rb#90
  def initialize(task, signal:, outputs:, exec_context:); end

  # @api semi-private
  #
  # source://trailblazer-activity//lib/trailblazer/activity/circuit.rb#88
  def signal; end
...
#
# source://trailblazer-activity//lib/trailblazer/activity/circuit/task_adapter.rb#23
...
#
# source://trailblazer-activity//lib/trailblazer/activity/circuit/task_adapter.rb#43
...
# source://trailblazer-activity//lib/trailblazer/activity/circuit/task_adapter.rb#52
class Trailblazer::Activity::Circuit::TaskAdapter
  ...
  # TODO: make me private!
  #
  # source://trailblazer-activity//lib/trailblazer/activity/circuit/task_adapter.rb#96
  def to_s; end
...
# source://trailblazer-activity//lib/trailblazer/activity/deprecate.rb#3
...
#
# source://trailblazer-activity//lib/trailblazer/activity/structures.rb#10
class Trailblazer::Activity::End
  ...
  # source://trailblazer-activity//lib/trailblazer/activity/structures.rb#27
  def inspect; end
...
#
# source://trailblazer-activity//lib/trailblazer/activity/introspect.rb#7
module Trailblazer::Activity::Introspect
  class << self
    # Public entry point for {Activity} instance introspection.
    #
    # source://trailblazer-activity//lib/trailblazer/activity/introspect.rb#9
    def Nodes(activity, task: T.unsafe(nil), **options); end

    # @private
    # @raise [ArgumentError]
    #
    # source://trailblazer-activity//lib/trailblazer/activity/introspect.rb#28
    def find_path(activity, segments); end

    # source://trailblazer-activity//lib/trailblazer/activity/introspect.rb#46
    def render_task(proc); end
  end
end

# source://trailblazer-activity//lib/trailblazer/activity/introspect.rb#18
module Trailblazer::Activity::Introspect::Nodes
  class << self
    # @private
    # @return Attributes data structure
    #
    # source://trailblazer-activity//lib/trailblazer/activity/introspect.rb#21
    def find_by_id(nodes, id); end
  end
end

# @private
#
# source://trailblazer-activity//lib/trailblazer/activity/introspect/render.rb#5
module Trailblazer::Activity::Introspect::Render
  private

  # source://trailblazer-activity//lib/trailblazer/activity/introspect/render.rb#8
  def call(activity, **options); end

  # source://trailblazer-activity//lib/trailblazer/activity/introspect/render.rb#40
  def inspect_end(task); end

  # source://trailblazer-activity//lib/trailblazer/activity/introspect/render.rb#36
  def inspect_task(task); end

  # If Ruby had pattern matching, this function wasn't necessary.
  #
  # source://trailblazer-activity//lib/trailblazer/activity/introspect/render.rb#31
  def inspect_with_matcher(task, inspect_task: T.unsafe(nil), inspect_end: T.unsafe(nil)); end

  # source://trailblazer-activity//lib/trailblazer/activity/introspect/render.rb#47
...
# source://trailblazer-activity//lib/trailblazer/activity/structures.rb#40
...
#
# source://trailblazer-activity//lib/trailblazer/activity/structures.rb#46
...
# source://trailblazer-activity//lib/trailblazer/activity/structures.rb#38
...
#
# source://trailblazer-activity//lib/trailblazer/activity/schema.rb#5
class Trailblazer::Activity::Schema < ::Struct
  class << self
    ...
    #
    # source://trailblazer-activity//lib/trailblazer/activity/schema.rb#26
    def Nodes(nodes); end
  end
end
...
#
# source://trailblazer-activity//lib/trailblazer/activity/schema/implementation.rb#4
module Trailblazer::Activity::Schema::Implementation
  class << self
    # source://trailblazer-activity//lib/trailblazer/activity/schema/implementation.rb#8
...
#
# source://trailblazer-activity//lib/trailblazer/activity/schema/implementation.rb#6
...
# @private This class might get removed in 0.17.0.
#
# source://trailblazer-activity//lib/trailblazer/activity/schema/intermediate.rb#6
class Trailblazer::Activity::Schema::Intermediate < ::Struct
  class << self
    # source://trailblazer-activity//lib/trailblazer/activity/schema/intermediate.rb#14
    def Out(*args); end
...
# @private This class might get removed in 0.17.0.
#
# source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#6
module Trailblazer::Activity::Schema::Intermediate::Compiler
  ...
  #
  # source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#15
  ...
  #
  # source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#69
  def connections_for(intermediate_outs, task_outputs, implementation); end

  # Run all Implementation::Task.extensions and return new {config}
  #
  # source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#92
  def invoke_extensions_for(config, impl_task, id); end

  # In an array of {Activity::Output}, find the output matching {semantic}.
  #
  # source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#99
  def output_for_semantic(outputs, semantic); end

  # From the intermediate "template" and the actual implementation, compile a {Circuit} instance.
  #
  # source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#26
  def schema_components(intermediate, implementation, config); end

  # source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#78
  def terminus_to_output(intermediate, implementation); end
...
#
# source://trailblazer-activity//lib/trailblazer/activity/schema/compiler.rb#9
Trailblazer::Activity::Schema::Intermediate::Compiler::DEFAULT_CONFIG = T.let(T.unsafe(nil), Hash)

# source://trailblazer-activity//lib/trailblazer/activity/schema/intermediate.rb#8
...
#
# source://trailblazer-activity//lib/trailblazer/activity/schema/intermediate.rb#7
...
# source://trailblazer-activity//lib/trailblazer/activity/schema.rb#11
class Trailblazer::Activity::Schema::Nodes < ::Hash; end

# In Attributes we store data from Intermediate and Implementing compile-time.
# This would be lost otherwise.
#
# source://trailblazer-activity//lib/trailblazer/activity/schema.rb#14
class Trailblazer::Activity::Schema::Nodes::Attributes < ::Struct
  # Returns the value of attribute data
  #
  # @return [Object] the current value of data
  #
...
# source://trailblazer-activity//lib/trailblazer/activity/structures.rb#36
class Trailblazer::Activity::Signal; end

# source://trailblazer-activity//lib/trailblazer/activity/structures.rb#30
...
#
# source://trailblazer-activity//lib/trailblazer/activity/circuit/task_adapter.rb#101
module Trailblazer::Activity::TaskBuilder
  class << self
    ...
    # source://trailblazer-activity//lib/trailblazer/activity/circuit/task_adapter.rb#109
...
#   |-- Wrap::End
#
# source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#2
module Trailblazer::Activity::TaskWrap
  ...
  def container_activity_for(activity, wrap_static: T.unsafe(nil), id: T.unsafe(nil), **config); end
  ...
  class << self
    ...
    def wrap_static_for(task, activity); end
  end
end
...
#     step's taskWrap
#
# source://trailblazer-activity//lib/trailblazer/activity/task_wrap/extension.rb#29
class Trailblazer::Activity::TaskWrap::Extension
  # @return [Extension] a new instance of Extension
  #
  # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/extension.rb#38
  ...
  #
  # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/extension.rb#44
  ...
  class << self
    ...
    def WrapStatic(*inserts); end

    # Build a taskWrap extension from the "friendly interface" {[task, id:, ...]}
    #
    # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/extension.rb#31
...
#
# source://trailblazer-activity//lib/trailblazer/activity/task_wrap/extension.rb#58
class Trailblazer::Activity::TaskWrap::Extension::WrapStatic
  # @return [WrapStatic] a new instance of WrapStatic
  #
  # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/extension.rb#59
  def initialize(extension:); end

  # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/extension.rb#63
  def call(config:, task:, **_arg2); end
end

# source://trailblazer-activity//lib/trailblazer/activity/task_wrap.rb#56
...
#
# source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#9
class Trailblazer::Activity::TaskWrap::Pipeline
  ...
  class << self
    # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#26
    def Row(id, task); end
  end
end

# source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#30
class Trailblazer::Activity::TaskWrap::Pipeline::Row < ::Array
  # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#31
  def id; end
end

# Implements adapter for a callable in a Pipeline.
#
# source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#37
class Trailblazer::Activity::TaskWrap::Pipeline::TaskAdapter < ::Trailblazer::Activity::Circuit::TaskAdapter
  # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#48
  ...
  class << self
    ...
    #
    # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/pipeline.rb#42
...
#
# source://trailblazer-activity//lib/trailblazer/activity/task_wrap/runner.rb#7
module Trailblazer::Activity::TaskWrap::Runner
  class << self
    ...
    #
    # source://trailblazer-activity//lib/trailblazer/activity/task_wrap/runner.rb#36
    def merge_static_with_runtime(task, wrap_runtime:, activity:, **circuit_options); end
  end
end

# source://trailblazer-activity//lib/trailblazer/activity/version.rb#2
module Trailblazer::Version; end

# source://trailblazer-activity//lib/trailblazer/activity/version.rb#3
