...
class CableReady::Channels
  ...
  # source://cable_ready//lib/cable_ready/channels.rb#46
  def clear_channel(channel); end
end
...
class CableReady::Config
  ...
  class << self
    ...
    # source://cable_ready//lib/cable_ready/config.rb#14
    def allocate; end
...
class CableReady::Engine < ::Rails::Engine; end
