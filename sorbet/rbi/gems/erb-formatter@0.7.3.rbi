...
class ERB::Formatter
  ...
  #
  # source://erb-formatter//lib/erb/formatter.rb#81
  ...
  #
  # source://erb-formatter//lib/erb/formatter.rb#122
  def erb_tags; end
  ...
  # source://erb-formatter//lib/erb/formatter.rb#341
  def format; end

  # source://erb-formatter//lib/erb/formatter.rb#128
  def format_attributes(tag_name, attrs, tag_closing); end

  # source://erb-formatter//lib/erb/formatter.rb#286
  def format_erb_tags(string); end

  # source://erb-formatter//lib/erb/formatter.rb#263
  def format_ruby(code, autoclose: T.unsafe(nil)); end

  # source://erb-formatter//lib/erb/formatter.rb#227
  ...
  # source://erb-formatter//lib/erb/formatter.rb#221
  ...
  # source://erb-formatter//lib/erb/formatter.rb#206
  def raise(message); end

  # source://erb-formatter//lib/erb/formatter.rb#112
  ...
  # source://erb-formatter//lib/erb/formatter.rb#197
  def tag_stack_pop(tag_name, code); end

  # source://erb-formatter//lib/erb/formatter.rb#192
  ...
  # Returns the value of attribute html.
  #
  # source://erb-formatter//lib/erb/formatter.rb#126
  def to_s; end
...
module ERB::Formatter::DebugShovel
  # source://erb-formatter//lib/erb/formatter.rb#71
  def <<(string); end
end
...
# source://erb-formatter//lib/erb/formatter.rb#68
...
ERB::Formatter::RUBY_STANDALONE_BLOCK = T.let(T.unsafe(nil), Regexp)
