...
describe('DrawerController', () => {
  ...
  beforeEach(() => {
    ...
    contentElement = document.querySelector('[data-drawer-target="content"]');
    toggleButton = document.querySelector('[data-action="click->drawer#toggle"]');
  ...
  test('toggleDrawer toggles the CSS classes correctly', () => {
    ...
    expect(document.body.classList.contains('drawer-is-expanded')).toBe(true);
    ...
    expect(document.body.classList.contains('drawer-is-expanded')).toBe(false);
  });
