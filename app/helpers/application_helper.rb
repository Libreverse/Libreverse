...
module ApplicationHelper
  ...
  # NOTE: generate_inline_asset_importmap was removed.
  # Thredded JS is now compiled via Sprockets (see app/assets/javascripts/thredded.js)
  # Timeago is imported directly in app/javascript/vendor_imports.js
  ...
  def inline_umami_script
    ...
    javascript_include_tag "https://cloud.umami.is/script.js",
                           data: { website_id: "f46b6f42-9743-4ef0-9e1f-b16833b02897" },
                           async: true,
                           defer: true
  end
