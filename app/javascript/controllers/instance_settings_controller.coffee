...
export default class extends ApplicationController
  ...
  toggleAutomoderation: (event) ->
    ...
    @markDirty({ automoderation: !currentValue })
  ...
  toggleEeaMode: (event) ->
    ...
    @markDirty({ eeaMode: !currentValue })
  ...
  toggleForceSsl: (event) ->
    ...
    @markDirty({ forceSsl: !currentValue })
  ...
  updatePort: (event) ->
    ...
    # Update store
    @markDirty({ port: parseInt(value) || 3000 })
