...
export default _class = function () {
    ...
    _Class = class extends Controller {
        ...
        disconnect() {
            ...
            if ((reference = this.nekoEl) != undefined) {
                reference.removeEventListener("click", this.explodeHearts);
            }
            if (this.requestId) {
                // Cancel animation
        ...
        initNeko() {
            boundMethodCheck(this, _class);
            if (this.nekoPosX == undefined) {
                // Only initialize values that weren't loaded from saved state
                this.nekoPosX = 32;
            }
            if (this.nekoPosY == undefined) {
                this.nekoPosY = 32;
            }
            if (this.mousePosX == undefined) {
                this.mousePosX = 0;
            }
            if (this.mousePosY == undefined) {
                this.mousePosY = 0;
            }
        ...
        loop(timestamp) {
            ...
            return (this.requestId = globalThis.requestAnimationFrame(
                this.loop,
            ));
        }
        ...
        idle() {
            ...
            if (
                ...
                this.idleAnimation =
                    availableAnims[
                        Math.floor(Math.random() * availableAnims.length)
                    ];
            }
        ...
        setSprite(name, frameNumber) {
            ...
            boundMethodCheck(this, _class);
            sprite =
                this.spriteSets[name][
                    frameNumber % this.spriteSets[name].length
                ];
