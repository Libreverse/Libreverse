...
export default class extends ApplicationController {
    ...
    toggleHover(/* event */) {
        ...
        console.log(
            "Sidebar toggleHover triggered - Before Reflex HTML:",
            beforeHtml,
        );

        this.stimulate("SidebarReflex#toggle_hover", this.element)
            .then(() => {
                const afterHtml = this.element.outerHTML;
                console.log(
                    "Sidebar toggleHover triggered - After Reflex HTML:",
                    afterHtml,
                );
