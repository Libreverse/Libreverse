...
console.info("[MetaverseHydration] pack evaluating", { ReactOnRailsImported: typeof ReactOnRails });
...
document.addEventListener("turbo:before-render", () => resetHydration("turbo:before-render"));
document.addEventListener("turbo:render", () => triggerHydration("turbo:render"));
